...
async function updateOptionsFromProject(options) {
  ...
  if (!sucraseOpts.transforms.includes("typescript")) {
    sucraseOpts.transforms.push2","s","text-bold\"","<h2","\"publicacion\"","imagen-papa","Fred","class=\"botones\"","\"actualizar\"","class=\"eliminar","4rem","icono","<a","<li><button>","<li><button","white","span","<span>","contenido","<h2>","publicacion","class=\"publicacion\"","imagen","class=\"imagen-papa\"","hidden","im","img","<img","bold","p","<p>","Disponibles","botones","class=\"botones","id","<button","div class=\"casilla\"","<input","documento","contraseÃ±a","3306","inn","innodb_force_recovery","[mysqld]","innodb_log_file_size"]óÜ‚}      â    úôîèâÜÖâÊïŒ1ºQ9~                                                                                                                                                                                                                                         &!?vscode.git{"closedRepositories":[]}   ;terminal.integrated.environmentVariableCollectionsV2[]…=‰m__$__targetStorageMarker{"workbench.explorer.views.state":1,"workbench.view.search.state":1,"workbench.scm.views.state":1,"workbench.panel.markers":1,"workbench.panel.output":1,"terminal":1,"workbench.activity.viewletsWorkspaceState":1,"workbench.panel.viewContainersWorkspaceState":1,"workbench.auxiliarybar.