  ...
  return (file) => {
    ...
    if (largeDirectory) {
      ...
      log.warn('broad-content-glob-pattern', [
        ...
        `See our documentation for recommendations:@  e          ‹      ‹  n n n      , ˆ                     8            Ç€ûÒcÁO¯…O4+m		     System.Numerics H           €Ö¦i/ìpïE®ÇïâzØ&       Microsoft.PowerShell.ConsoleHost0           €P!ÂÀ:øA¬
ùÖ©ÜŸó      System  4           €sÚÔ<ÈO”hœàrv      System.Core D           €$X¦oäHJI³Wº(^M      System.Management.AutomationL           €?_ïC¼EYç®AM     # Microsoft.Management.Infrastructure 4           €F’Iâ^ÈM‘_Ù¾ ºÛ}     
 System.Xml  <           €¤ÿ˜g÷ÅC&	3eú      System.Management   @           €lê¾52ORtÎº%•      System.DirectoryServices4           €Y´]ÌƒsN•‚ß¹æ­P      System.Data <           €&cb„1B´u`»)¯º      System.ConfigurationH           €÷@:;Î D˜Ny!‘z      Microsoft.PowerShell.Security   <           €YÕOÓ;bD¡æ8IJÄÒÅ      System.Transactions H           @hr(2XiC ¾±Q³j‚     Microsoft.PowerShell.PSReadLine P           €Ö/Y†@Ò>AŸÆÂfánm     ( Microsoft.PowerShell.Commands.Manage