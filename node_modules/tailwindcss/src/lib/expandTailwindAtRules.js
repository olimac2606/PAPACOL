...
// not too important for subsequent builds. The faster the better though ‚Äî if we can speed
...
export default function expandTailwindAtRules(context) {
  return async (root) => {
    ...
    root.walkAtRules('layer', (rule) => {
      if (Object.keys(layerNodes).includes(rule.paraMAMlD  §∑¶™®«´À®«ê»†À∏«∫ª∏ö…»ßôª«¨ ôáô»ò∏ò©»á