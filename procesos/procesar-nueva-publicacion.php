...
try {
    ...
    header("Location: /PAPACOL/pages/panel-agricultor.php?color=bg-verdeClaroCustom&mensaje=Nueva publicación creada con éxito.");
    exit();
} catch (PDOException $e) {
    error_log("Error al insertar publicación: " . $e->getMessage());
    header("Location: /PAPACOL/pages/panel-agricultor.php?color=bg-rojoClaroCustom&mensaje=Error al crear nueva publicación por favor intente de nuevo o mas tarde.");
    exit();
}
?>